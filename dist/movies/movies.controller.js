...
const dto_pagination_1 = require("./dto/dto_pagination ");
let MoviesController = class MoviesController {
    ...
    findBySearch(paginationDto) {
        return this.moviesService.findBySearch(paginationDto);
    }
    findOne(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_pagination_1.PaginationDto]),
    __metadata("design:returntype", void 0)
], MoviesController.prototype, "findBySearch", null);
__decorate([
    (0, common_1.Get)(":id"),
